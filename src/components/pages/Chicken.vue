<template>
    <div class="meatAll py-5">
        ...
        <div class="row justify-content-center py-5">
            <div class="col">
                <img src="https://i.imgur.com/K2sspvU.png" alt="Beef Menu" class="slogan"
                style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%)">              
            </div>
        </div>
        <div class="row py-5 cardRow justify-content-center">
        <div class="cardCol" v-for="(item, index) in products" :key="index">
            <div class="col-md-4 card border-0 px-3 productsCard"  v-if="item.category === '雞肉' || item.category === 'BEST雞肉'" style="height: 400px">
